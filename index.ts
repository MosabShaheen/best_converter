...
async function converter() {
    ...
    let curre: string[] = ["$ Dollar", "Rs Pakistani Rupees", "Euro", "Indian Rupee", "Saudi Riyal", "Turkish lira", "Indonesian Rupiah", "United Arab Emirates Dirham", "Chinese Yuan", "Japanese Yen"]
